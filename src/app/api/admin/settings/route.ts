...
const DEFAULTS: Record<string, { title: string; content: string }> = {
  ...
  contact: {
    title: "Contact",
    content: `<h2>Email</h2><p>hello@avoryne.com</p><h2>Support</h2><p>We typically respond within one business day.</p>`,
  },
};
