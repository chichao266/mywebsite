...
const SYSTEM_SETTINGS = [
  { key: "system_site_name", title: "站点名称", placeholder: "Agatelier", desc: "浏览器标签页和页脚显示的名称" },
  { key: "system_site_desc", title: "站点描述", placeholder: "手工玉石与玛瑙珠宝品牌", desc: "SEO 描述，搜索引擎展示用" },
  { key: "system_contact_email", title: "联系邮箱", placeholder: "hello@agatelier.com", desc: "Contact Us 页面和邮件通知" },
