...
const SYSTEM_SETTINGS = [
  { key: "system_site_name", title: "站点名称", placeholder: "Lumea", desc: "浏览器标签页和页脚显示的名称" },
  { key: "system_site_desc", title: "站点描述", placeholder: "Lab-grown diamond and colored gemstone jewelry", desc: "SEO 描述，搜索引擎展示用" },
  { key: "system_contact_email", title: "联系邮箱", placeholder: "hello@lumeajewelry.com", desc: "Contact Us 页面和邮件通知" },
