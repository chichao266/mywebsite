...
const categories = ["All", "Lab Diamonds", "Lab Sapphires", "Lab Emeralds", "Lab Rubies"];
      ...
      <section className="border-b bg-white">
        <div className="container mx-auto px-4 py-14 text-center sm:px-6 sm:py-18">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-sm leading-6 text-muted-foreground">
            Diamonds, sapphires, rubies, and emeralds selected for clean color, practical settings, and everyday wear.
          </p>
      ...
      <section className="bg-background py-7">
        <div className="container mx-auto flex gap-2 overflow-x-auto px-4 sm:px-6">
          {categories.map((item) => {
            ...
            const href = item === "All" ? "/products" : `/products?category=${encodeURIComponent(item)}`;
            return (
              <Link
                key={item}
                href={href}
